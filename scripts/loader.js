function preload() {
    ...
    scenarioFrontImg = loadImage('assets/background/foreground.png');

    mageBulletImg = loadImage('assets/attacks/mage-bullet-13x13.png');
    mageFlameImg = loadImage('assets/attacks/flameball-32x32.png');
